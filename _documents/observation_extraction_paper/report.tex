...
%    address)}
  ...
  \texttt{marco.seeland@tu-ilmenau.de} \\
  %% \AND
  %% Coauthor \\
  %% Affiliation \\
  %% Address \\
...
\begin{abstract}
\textbf{\textit{Problem:}} 
- primary challenge: strutured data extraction from natural language reports on wild bee observations using Large Language Models (LLMs)\\

% The primary challenge addressed in this research is the labor-intensive process of transforming unstructured data into a structured dataset, particularly in the domain of biodiversity research on wild bees. 
% - Extracting structured data from natural language reports on wild bee observations is a labor-intensive process that requires domain expertise and deep language understanding
% Manual extraction and interpretation of observation data from numerous scientific reports is time-consuming and requires deep domain expertise.

\textbf{\textit{Questions:}} 

- How to evaluate on facts represented in natural language?
- What influence prompts and few-shot examples have on the extraction results?
...
\input{figs/mapping_pseudocode.tex}
...
- Input Reports must be of high quality (OCR, symbols, content connections)
...
\input{figs/extraction_prompt.tex}
